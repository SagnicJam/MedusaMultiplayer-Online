...
namespace MedusaMultiplayer
{
    public class GridManager : MonoBehaviour
    {
        ...
        {
            liveTornadoAnimationsDic.Add(cellTornadoDropped, Instantiate(MultiplayerGamePrefab.instance.tornadoAnimation, cellToworld(cellTornadoDropped), Quaternion.identity));
        }
        ...
        public void PlaceBoulderAnimation(Vector3Int cellBoulderDropped)
        {
            ...
            //}
            GameObject g = Instantiate(MultiplayerGamePrefab.instance.rockFormation, cellToworld(cellBoulderDropped), Quaternion.identity);
        ...
        {
            GameObject g = Instantiate(MultiplayerGamePrefab.instance.rockRemoval, cellToworld(cellBoulderRemoved), Quaternion.identity);
            FrameLooper fL = g.GetComponent<FrameLooper>();
            fL.PlayOneShotAnimation();
            fL.onPlayOneShotAnimation.RemoveAllListeners();
            fL.onPlayOneShotAnimation.AddListener(() =>
                ...
                if (gameStateDependentTileArray[(int)tType - 1].cereberustileToggle)
                {
                    switch (tType)
                    {
                        case EnumData.TileType.RightCereberusHead:
                            ...
                            {
                                Instantiate(MultiplayerGamePrefab.instance.rightFire, worldPos, Quaternion.identity);
                        ...
                        case EnumData.TileType.LeftCereberusHead:
                            ...
                            if (!IsCellBlockedForPetrifiedUnitMotionAtPos(grid.WorldToCell(worldPos)) || IsCellContainingMirrorAtPos(grid.WorldToCell(worldPos)))
                            {
                                Instantiate(MultiplayerGamePrefab.instance.leftFire, worldPos, Quaternion.identity);
                                gameStateDependentTileArray[(int)tType - 1].tileMap.SetTile(cellPos, gameStateDependentTileArray[(int)tType - 1].tile);
                            }
                            else
                            {
                        ...
                        case EnumData.TileType.DownCereberusHead:
                            ...
                            if (!IsCellBlockedForPetrifiedUnitMotionAtPos(grid.WorldToCell(worldPos)) || IsCellContainingMirrorAtPos(grid.WorldToCell(worldPos)))
                            {
                                Instantiate(MultiplayerGamePrefab.instance.downFire, worldPos, Quaternion.identity);
                                gameStateDependentTileArray[(int)tType - 1].tileMap.SetTile(cellPos, gameStateDependentTileArray[(int)tType - 1].tile);
                            }
                            else
                            {
                        ...
                        case EnumData.TileType.UpCereberusHead:
                            ...
                            if (!IsCellBlockedForPetrifiedUnitMotionAtPos(grid.WorldToCell(worldPos)) || IsCellContainingMirrorAtPos(grid.WorldToCell(worldPos)))
                            {
                                Instantiate(MultiplayerGamePrefab.instance.upFire, worldPos, Quaternion.identity);
                                gameStateDependentTileArray[(int)tType - 1].tileMap.SetTile(cellPos, gameStateDependentTileArray[(int)tType - 1].tile);
                            }
                            else
                            {
        ...
        {
            GameObject lightningGO = Instantiate(MultiplayerGamePrefab.instance.lightning, cellToworld(explodeCell), Quaternion.identity);
            ...
            lightningGO.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
            {
                ...
                GameObject bigThunderGO = Instantiate(MultiplayerGamePrefab.instance.bigExplosion, cellToworld(explodeCell), Quaternion.identity);
                ...
                bigThunderGO.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                {
                    ...
                    {
                        GameObject smallThunderGOPlus = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(plusCell[i]), Quaternion.identity);
                        ...
                        if (i == plusCell.Count - 1)
                        {
                            smallThunderGOPlus.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                            {
                                ...
                                {
                                    GameObject smallThunderGOCorner = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(cornerCell[j]), Quaternion.identity);
                                    ...
                                    if (j == cornerCell.Count - 1)
                                    {
                                        ...
                                        for (int k = 0; k < plusCell.Count; k++)
                                            {
                                                GameObject smallThunderGOPlusFast = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(plusCell[k]), Quaternion.identity);
                                                ...
                                                if (k == plusCell.Count - 1)
                                                {
                                                    smallThunderGOPlusFast.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                                                    {
                                                        ...
                                                        {
                                                            GameObject smallThunderGOCornerFast = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(cornerCell[l]), Quaternion.identity);
                                                            ...
                                                            if (l == cornerCell.Count - 1)
                                                            {
                                                                smallThunderGOCornerFast.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                                                                {
                                                                    ...
                                                                    {
                                                                        GameObject smallThunderGOPlusDoubleFast = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(plusCell[m]), Quaternion.identity);
                                                                        ...
                                                                        if (m == plusCell.Count - 1)
                                                                        {
                                                                            smallThunderGOPlusDoubleFast.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                                                                            {
                                                                                ...
                                                                                {
                                                                                    GameObject smallThunderGOCornerDoubleFast = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(cornerCell[n]), Quaternion.identity);
                                                                                    ...
                                                                                    if (n == cornerCell.Count - 1)
                                                                                    {
                                                                                        smallThunderGOCornerDoubleFast.GetComponent<FrameLooper>().onPlayOneShotAnimation.AddListener(() =>
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                GameObject smallThunderGOPlusFourXFast = Instantiate(MultiplayerGamePrefab.instance.smallExplosion, cellToworld(plusCell[o]), Quaternion.identity);
        ...
        void Earthquake(Hero hero, List<Vector3Int> plusCell)
        {
            ...
            for (int i = 0; i < plusCell.Count; i++)
            {
                EarthQuake earthQuake = Instantiate(MultiplayerGamePrefab.instance.earthquake, cellToworld(plusCell[i]), Quaternion.identity).GetComponent<EarthQuake>();
