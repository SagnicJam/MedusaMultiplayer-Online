...
namespace MedusaMultiplayer
{
    public class MultiplayerManager : MonoBehaviour
    {
        ...
        {
            enterNameGORef = Instantiate(MultiplayerGamePrefab.instance.enterNameGO, Canvas, false);
        }

        public void EstablishConnection(string username)
        {
            signalRGORef = Instantiate(MultiplayerGamePrefab.instance.signalRGO, Canvas, false);
        ...
        {
            playerListRef = Instantiate(MultiplayerGamePrefab.instance.playerListGO, Canvas, false);
            playerListRef.GetComponent<PlayerList>().DisplayAllPlayerList(room);
        }

        public void InitialiseLobbyScreen()
        {
            lobbyGORef = Instantiate(MultiplayerGamePrefab.instance.lobbyGO, Canvas, false);
        }

        public void InitialiseRoomList(Lobby lobby)
        {
            roomListRef = Instantiate(MultiplayerGamePrefab.instance.roomListGO, Canvas, false);
            roomListRef.GetComponent<RoomList>().DisplayRoomList(lobby);
        }

        public void InstantiateMatchOptions(int roomId)
        {
            matchConditionManagerGORef = Instantiate(MultiplayerGamePrefab.instance.matchConditionManagerGO, Canvas, false);
