...
namespace MedusaMultiplayer
{
    public class ServerMasterController : MonoBehaviour
    {
        ...
        {
            Hero serverInstanceHero = Instantiate(MultiplayerGamePrefab.instance.GetServerInstancePlayer((EnumData.Heroes)characterHero), transform, false).GetComponentInChildren<Hero>();
