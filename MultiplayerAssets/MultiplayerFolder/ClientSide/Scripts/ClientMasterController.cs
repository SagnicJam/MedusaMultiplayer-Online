...
namespace MedusaMultiplayer
{
    public class ClientMasterController : MonoBehaviour
    {
        ...
        public void SetCharacter(int hero, PlayerFlyData playerFlyData, PositionUpdates positionUpdates)
        {
            ...
            {
                Hero localHero = (Instantiate(MultiplayerGamePrefab.instance.GetLocalPlayer((EnumData.Heroes)hero), transform, false)).GetComponentInChildren<Hero>();
                Hero serverPredictedHero = (Instantiate(MultiplayerGamePrefab.instance.GetServerPredictedPlayer((EnumData.Heroes)hero), transform, false)).GetComponentInChildren<Hero>();
                Hero remoteClientHero = (Instantiate(MultiplayerGamePrefab.instance.GetRemotePlayer((EnumData.Heroes)hero), transform, false)).GetComponentInChildren<Hero>();
            ...
            {
                Hero remoteOtherClient = (Instantiate(MultiplayerGamePrefab.instance.GetRemoteOtherClientPlayer((EnumData.Heroes)hero), transform, false)).GetComponentInChildren<Hero>();
